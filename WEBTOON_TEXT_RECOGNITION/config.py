...
#PRETRAINED_MODEL_PATH = './pretrained_models/WTR_RES/transfer-wtr-1.pth'
#PRETRAINED_MODEL_PATH = './pretrained_models/VGG/wtr-VGG16-11.pth'
LABEL_PATH = './train/labels-2194.txt' #LABEL_PATH = './train/labels-2194.txt'
...
NUM_CLASSES = 2194 #561 #2194
DISPLAY_INTERVAL = 100

#PIPELINEING WITH TEXT DETECTION RESULT
TEST_RECOG_PATH = '../SPECIAL_TEXT_DETECTION/test/preditions/res/'
SPACING_WORD_PATH = '../SPECIAL_TEXT_DETECTION/test/preditions/spacing_word/spacing_word.txt'
