...
def getDetBoxes_core(textmap, linkmap, text_threshold, link_threshold, low_text):
    # prepare data
    linkmap = linkmap.copy() #link score heatamp
    textmap = textmap.copy() #text score heatmap
...
def getDetBoxes(textmap, linkmap, text_threshold, link_threshold, low_text, poly=False):
    ...
    #debug.getScalaValue(polys)
    #boxes -> there is in coordinate of boxes
    #polys -> it is same as boxes, but there is no polys in images generally
    return boxes, polys
