...
#TRANSFER CASE#
TRANSFER_CASE = '사막락락다나날락았락마만가갑락완아라만라말짜정정건치치잠깐아싸럼만해만님선케나준남자정말너는과일는너아선물?!차만?안!!업나나자마자바산자잘가장잘알막라장갑자까다다만낙짜판잡ㅋㅋ하하ㅋㅋ한한다ㅋㅋ한다할ㅋ한나쌍왕따와말ㅋ과ㅋ맞각난ㅋㅋ말다ㅋ한만습하놔박습쏠짝1까님습말잘하한아안빨아만화나라마가하하빨가라'

TRAIN_IMAGE_PATH = '/nipa/ACTOON_v7/ACTOON/text_recognition/train/images/'
TEST_IMAGE_PATH = './test/images/'
TEST_CUSTOM_IMAGE_PATH = './test/custom/'
TEST_PREDICTION_PATH = './predictions/'

TRANFSER_TRAIN_IMAGE_PATH = '/root/recognition_train/transfer_train_data/'
TRANSFER_TRAIN_CSV_PATH = './text_recognition/train/transfer_train/label.csv'

TRAIN_FONTS_PATH = './train/fonts/'
TEST_FONTS_PATH = './test/fonts/'

TRAIN_CSV_PATH = '/nipa/ACTOON_v7/ACTOON/text_recognition/train/label.csv'
TEST_CSV_PATH = './test/label.csv'
TEST_CUSTOM_CSV_PATH = 'test/custom/label.csv'
CUSTOM_TEST_GT_PATH = './test/custom/gt.txt'

SAVED_MODEL_PATH = './text_recognition/saved_models/'
TEXT_RECOGNIZER_MODEL_PATH = './text_recognition/pretrained_models/Webtoon-Text-Recognizer.pth'
LABEL_PATH = './text_recognition/train/labels-2213.txt'
...
TEST_RECOG_PATH = './recog/res/'
SPACING_WORD_PATH = './recog/spacing_word/spacing_word.txt'
